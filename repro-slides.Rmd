...
* **Option 1: I'm new to R/RStudio:** 
    * Go to http://bit.ly/reproduce_uscots15_rstudio
    * Claim an account, and don't forget to change the Taken column to "yes"
    * Log on to RStudio Server at the URL for the account you claimed, using "guest" as the username and the password for that account
